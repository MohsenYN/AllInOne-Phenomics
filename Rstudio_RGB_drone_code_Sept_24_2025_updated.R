...
EX1.Indices.myIndex <- fieldIndex(
  ...
  Blue = 3,
  myIndex = c(
    "(Red - Blue) / Red",                # Color Contrast Index (CCI)
    "2 * Green - Red - Blue",            # Excess Green Vegetation Index (EGVI)
    "(1.4 * Red) - Green",               # Excess Red Vegetation Index (ERVI)
    "Green / Blue",                      # Green-Blue Index (GBI)
    "Green - (Red + Blue) / 2",          # Green Difference Index (GD)
    "(25 * (Green - Red) / (Green + Red - Blue)) + 1.25",  # Green Leaf Area Index (GLAI)
    "Green / Red",                       # Green-Red Index (GR)
    "(Green^2 - Red^2) / (Green^2 + Red^2)",  # Modified Green Vegetation Ratio Index (MGVRI)
    "Blue / (Red + Green + Blue)",       # Normalized Blue Index (NB)
    "Green / (Red + Green + Blue)",      # Normalized Green Index (NG)
    "(Green - Blue) / (Green + Blue)",   # Normalized Green-Blue Difference Index (NGBDI)
    "Red / (Red + Green + Blue)",        # Normalized Red Index (NR)
    "Red / Blue",                        # Red-Blue Index (RB)
    "(Red^2) / (Blue * Green^3)",        # Redness Index (RI)
    "((Red + Green + Blue) - 3 * Blue) / (Red + Green + Blue)",  # Saturation Index (S)
    "2 * (Red - Green - Blue) / (Green - Blue)",  # Shape Index (SHP)
    "(1 + 0.5) * (Green - Red) / (Green + Red + 0.5)",  # Soil Adjusted Vegetation Index (SAVI)
    "(Green - Red) / (Green + Red)",     # Vegetation Index Green (VIG)
    "(Green - Red) / (Green + Red)",     # Normalized Green-Red Difference Index (NGRDI)
    "(Green - Blue) / (Green + Blue)",   # Blue-Green Index (BGI)
    "(Red - Blue) / Green",              # Custom 1: Color contrast measure (Red-Blue)/Green
    "Red / Green"                        # Custom 2: Red to Green ratio
  ),
  plot = TRUE
)
